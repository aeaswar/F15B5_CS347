...
,p_default_workspace_id=>13309716558417081050
,p_default_application_id=>93435
,p_default_owner=>'SIM1'
);
end;
/
prompt --application/set_environment
 
prompt APPLICATION 93435 - Rest Test Mobile
--
-- Application Export:
--   Application:     93435
--   Name:            Rest Test Mobile
--   Date and Time:   06:56 Tuesday November 24, 2015
--   Exported By:     CLARKCLAYTON@UTEXAS.EDU
--   Flashback:       0
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,93435)
,p_owner=>nvl(wwv_flow_application_install.get_schema,'SIM1')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Rest Test Mobile')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_93435')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'AB1C295832B0C7E603CB3F81E849437BA38B7B394CEBC5CF2E8505DD51767FBA'
...
,p_authentication_id=>wwv_flow_api.id(15384254970807055345)
...
,p_csv_encoding=>'Y'
,p_last_updated_by=>'CLARKCLAYTON@UTEXAS.EDU'
,p_last_upd_yyyymmddhh24miss=>'20151124052418'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(15384246115508055312)
,p_name=>'Mobile Navigation Menu'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(15384255812573055351)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(15432402485988841175)
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(15432317022420829556)
,p_name=>'gg'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(15432317217451829558)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Home'
,p_list_item_link_target=>'f?p=&APP_ID.:1:&APP_SESSION.::&DEBUG.:'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(15384245849009055311)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(15384245956050055311)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(15384246040071055312)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(15384254846923055343)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(15384255023409055345)
,p_name=>' Breadcrumb'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15384246252545055312)
,p_theme_id=>51
,p_name=>'Dialog'
,p_is_popup=>true
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15384246382267055314)
,p_theme_id=>51
,p_name=>'Page'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(15384246461050055318)
,p_page_template_id=>wwv_flow_api.id(15384246382267055314)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(15384246546323055319)
,p_page_template_id=>wwv_flow_api.id(15384246382267055314)
,p_name=>'Footer Bar'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(15384246671577055319)
,p_page_template_id=>wwv_flow_api.id(15384246382267055314)
,p_name=>'Header Bar'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15384247155192055321)
,p_theme_id=>51
,p_name=>'Popup'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(15384249529688055329)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(15384253782635055332)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15384247254510055322)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15384247336859055324)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15384247490118055324)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15384247500584055324)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15384247676156055324)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15384247709390055324)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15384247826339055325)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15384247940091055325)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15384248038477055325)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15384248120586055325)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15384248224656055325)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15384248370794055325)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15384248496867055325)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15384248516823055326)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15384248737582055326)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15384248871142055327)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15384248907045055327)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15384249027943055327)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15384249127249055327)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(15384248679032055326)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(15384249271754055328)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(15384249309437055329)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(15384249409449055329)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(15384254192155055333)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(15384254004364055333)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(15384254677336055336)
,p_theme_id=>51
,p_theme_name=>'Mobile'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(15384246382267055314)
,p_default_dialog_template=>wwv_flow_api.id(15384246252545055312)
,p_error_template=>wwv_flow_api.id(15384246382267055314)
,p_printer_friendly_template=>wwv_flow_api.id(15384246382267055314)
,p_login_template=>wwv_flow_api.id(15384246382267055314)
,p_default_button_template=>wwv_flow_api.id(15384253782635055332)
,p_default_region_template=>wwv_flow_api.id(15384248370794055325)
,p_default_chart_template=>wwv_flow_api.id(15384248370794055325)
,p_default_form_template=>wwv_flow_api.id(15384248370794055325)
,p_default_reportr_template=>wwv_flow_api.id(15384248516823055326)
,p_default_tabform_template=>wwv_flow_api.id(15384248370794055325)
,p_default_wizard_template=>wwv_flow_api.id(15384248370794055325)
,p_default_irr_template=>wwv_flow_api.id(15384248370794055325)
,p_default_report_template=>wwv_flow_api.id(15384248679032055326)
,p_default_label_template=>wwv_flow_api.id(15384249309437055329)
,p_default_calendar_template=>wwv_flow_api.id(15384254004364055333)
,p_default_list_template=>wwv_flow_api.id(15384248907045055327)
,p_default_nav_list_template=>wwv_flow_api.id(15384248871142055327)
,p_default_top_nav_list_temp=>wwv_flow_api.id(15384248871142055327)
,p_default_side_nav_list_temp=>wwv_flow_api.id(15384249127249055327)
,p_default_nav_list_position=>'SIDE'
,p_default_dialogbtnr_template=>wwv_flow_api.id(15384247254510055322)
,p_default_dialogr_template=>wwv_flow_api.id(15384248370794055325)
,p_default_option_label=>wwv_flow_api.id(15384249309437055329)
,p_default_header_template=>wwv_flow_api.id(15384248038477055325)
,p_default_footer_template=>wwv_flow_api.id(15384247826339055325)
,p_default_required_label=>wwv_flow_api.id(15384249409449055329)
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(15384254249575055335)
,p_theme_id=>51
,p_name=>'Blue'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(15384254376133055335)
,p_theme_id=>51
,p_name=>'Dark'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(15384254440621055335)
,p_theme_id=>51
,p_name=>'Default'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(15384254560426055335)
,p_theme_id=>51
,p_name=>'Red'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(15384246759270055320)
,p_theme_id=>51
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(15384249661943055330)
,p_theme_id=>51
,p_name=>'ICON_BUTTON'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(15384250101409055330)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384246867382055321)
,p_theme_id=>51
,p_name=>'OVERLAY'
...
,p_group_id=>wwv_flow_api.id(15384246759270055320)
,p_template_types=>'PAGE'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384246974169055321)
,p_theme_id=>51
,p_name=>'PUSH'
,p_display_name=>'Push'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384247005010055321)
,p_theme_id=>51
,p_name=>'REVEAL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384249783877055330)
,p_theme_id=>51
,p_name=>'ICON_ACTION'
,p_display_name=>'Action'
,p_display_sequence=>100
,p_button_template_id=>wwv_flow_api.id(15384249529688055329)
,p_css_classes=>'ui-icon-action'
,p_group_id=>wwv_flow_api.id(15384249661943055330)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384249805879055330)
,p_theme_id=>51
,p_name=>'ICON_ALERT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384249909651055330)
,p_theme_id=>51
,p_name=>'ICON_BACK'
,p_display_name=>'Back'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384250006032055330)
,p_theme_id=>51
,p_name=>'ICON_BARS'
,p_display_name=>'Bars'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384250264208055330)
,p_theme_id=>51
,p_name=>'ICON_BOTTOM'
...
,p_group_id=>wwv_flow_api.id(15384250101409055330)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384250350201055330)
,p_theme_id=>51
,p_name=>'ICON_BULLETS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384250447516055330)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384250525251055330)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384250644906055330)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384250769349055330)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384250893727055331)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384250912061055331)
,p_theme_id=>51
,p_name=>'ICON_CHECK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384251043690055331)
,p_theme_id=>51
,p_name=>'ICON_CLOCK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384251138796055331)
,p_theme_id=>51
,p_name=>'ICON_CLOUD'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384251275193055331)
,p_theme_id=>51
,p_name=>'ICON_COMMENT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384251374757055331)
,p_theme_id=>51
,p_name=>'ICON_DELETE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384251462933055331)
,p_theme_id=>51
,p_name=>'ICON_EDIT'
,p_display_name=>'Edit'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384251521653055331)
,p_theme_id=>51
,p_name=>'ICON_GEAR'
,p_display_name=>'Gear'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384251612970055331)
,p_theme_id=>51
,p_name=>'ICON_GRID'
,p_display_name=>'Grid'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384251758097055331)
,p_theme_id=>51
,p_name=>'ICON_HOME'
,p_display_name=>'Home'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384251876654055331)
,p_theme_id=>51
,p_name=>'ICON_INFO'
,p_display_name=>'Info'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384251980898055331)
,p_theme_id=>51
,p_name=>'ICON_LEFT'
,p_display_name=>'Left'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384252043551055331)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384252152392055331)
,p_theme_id=>51
,p_name=>'ICON_LOCK'
,p_display_name=>'Lock'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384252269471055331)
,p_theme_id=>51
,p_name=>'ICON_MAIL'
,p_display_name=>'Mail'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384252374147055331)
,p_theme_id=>51
,p_name=>'ICON_MINUS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384252452600055332)
,p_theme_id=>51
,p_name=>'ICON_PHONE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384252578846055332)
,p_theme_id=>51
,p_name=>'ICON_PLUS'
,p_display_name=>'Plus'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384252666313055332)
,p_theme_id=>51
,p_name=>'ICON_POWER'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384252737706055332)
,p_theme_id=>51
,p_name=>'ICON_REFRESH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384252875527055332)
,p_theme_id=>51
,p_name=>'ICON_RIGHT'
,p_display_name=>'Right'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384252912478055332)
,p_theme_id=>51
,p_name=>'ICON_SEARCH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384253012015055332)
,p_theme_id=>51
,p_name=>'ICON_STAR'
,p_display_name=>'Star'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384253197912055332)
,p_theme_id=>51
,p_name=>'ICON_TAG'
,p_display_name=>'Tag'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384253252315055332)
,p_theme_id=>51
,p_name=>'ICON_TOP'
,p_display_name=>'Top'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384253351197055332)
,p_theme_id=>51
,p_name=>'ICON_USER'
,p_display_name=>'User'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384253444937055332)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384253533271055332)
,p_theme_id=>51
,p_name=>'NO_TEXT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384253659001055332)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384253821659055332)
,p_theme_id=>51
,p_name=>'INLINE_BUTTON'
,p_display_name=>'Inline Button'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_api.id(15384253782635055332)
,p_css_classes=>'ui-btn-inline'
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15384253958942055332)
,p_theme_id=>51
,p_name=>'ROUNDED_CORNERS'
,p_display_name=>'Rounded Corners'
,p_display_sequence=>1
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(15384254970807055345)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(15384254730793055338)
,p_ui_type_name=>'JQM_SMARTPHONE'
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_api.id(15384246115508055312)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>wwv_flow_api.id(15384249127249055327)
...
wwv_flow_api.create_page(
 p_id=>0
,p_user_interface_id=>wwv_flow_api.id(15384254730793055338)
...
,p_last_upd_yyyymmddhh24miss=>'20151022191331'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15384255371455055348)
,p_plug_name=>'Header'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(15384248038477055325)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15384255694312055349)
,p_plug_name=>'Footer'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(15384247826339055325)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15384255593706055349)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(15384255371455055348)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15384255442612055348)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15384255712480055350)
,p_name=>'open panel'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(15384255442612055348)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15384255712480055350)
,p_event_id=>wwv_flow_api.id(15384255712480055350)
,p_event_result=>'TRUE'
...
,p_last_updated_by=>'CLARKCLAYTON@UTEXAS.EDU'
,p_last_upd_yyyymmddhh24miss=>'20151022211651'
);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15384851364994328708)
,p_plug_name=>'doREST'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(15384248370794055325)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15384889683046328729)
,p_plug_name=>'Results'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(15384248516823055326)
...
'jt1.type type,',
'jt2.name name,',
'jt3.date_due date_due,',
'jt4.grade grade,',
'jt5.comments comments,',
'jt6.class_id class_id',
'from apex_collections t,',
'json_table(t.clob001, ''$.TYPE[*]'' COLUMNS rid for ordinality, type varchar2(20) path ''$'') jt1,',
'json_table(t.clob001, ''$.NAME[*]'' COLUMNS rid for ordinality, name varchar2(20) path ''$'') jt2,',
'json_table(t.clob001, ''$.DATE_DUE[*]'' COLUMNS rid for ordinality, date_due varchar2(15) path ''$'') jt3,',
'json_table(t.clob001, ''$.GRADE[*]'' COLUMNS rid for ordinality, grade varchar2(5) path ''$'') jt4,',
'json_table(t.clob001, ''$.COMMENTS[*]'' COLUMNS rid for ordinality, comments varchar2(50) path ''$'') jt5,',
'json_table(t.clob001, ''$.CLASS_ID[*]'' COLUMNS rid for ordinality, class_id varchar2(3) path ''$'') jt6',
'where t.collection_name = ''P2_DOREST_RESULTS'' and jt1.rid = jt2.rid and jt2.rid = jt3.rid and jt3.rid = jt4.rid and jt4.rid = jt5.rid and jt5.rid = jt6.rid',
'order by jt6.class_id, jt1.type'))
,p_plug_source_type=>'NATIVE_JQM_COLUMN_TOGGLE'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'STRIPE:STROKE'
);
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18323075866094238405)
,p_name=>'CLASS_ID'
,p_data_type=>'CLASS_ID'
,p_is_visible=>true
,p_display_sequence=>60
,p_heading=>'Class id'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18353888714421910023)
,p_name=>'NAME'
,p_data_type=>'NAME'
,p_is_visible=>true
,p_display_sequence=>20
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18353888882909910024)
,p_name=>'DATE_DUE'
,p_data_type=>'DATE_DUE'
,p_is_visible=>true
,p_display_sequence=>30
,p_heading=>'Date due'
,p_heading_alignment=>'CENTER'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18353888998637910025)
,p_name=>'GRADE'
,p_data_type=>'GRADE'
,p_is_visible=>true
,p_display_sequence=>40
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18353889090693910026)
,p_name=>'COMMENTS'
,p_data_type=>'COMMENTS'
,p_is_visible=>true
,p_display_sequence=>50
,p_heading=>'Comments'
,p_heading_alignment=>'CENTER'
...
wwv_flow_api.create_region_column(
 p_id=>wwv_flow_api.id(18363636356053793901)
,p_name=>'TYPE'
,p_data_type=>'TYPE'
,p_is_visible=>true
,p_display_sequence=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15384851721995328709)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(15384851364994328708)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(15384852174812328710)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15384852928439328717)
,p_name=>'P2_DB'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(15384851364994328708)
,p_item_default=>'jdbc:oracle:thin:@sayonara.microlab.cs.utexas.edu:1521:orcl'
,p_prompt=>'Db'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
,p_field_template=>wwv_flow_api.id(15384249309437055329)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15384853748481328722)
,p_name=>'P2_USER'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(15384851364994328708)
,p_item_default=>'C##cs347_cc47624'
,p_prompt=>'User'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15384854520622328722)
,p_name=>'P2_PASS'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(15384851364994328708)
,p_item_default=>'orcl_cc47624'
,p_prompt=>'Pass'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15384855323143328723)
,p_name=>'P2_MODE'
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(15384851364994328708)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15384856104686328724)
,p_name=>'P2_MODEL'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(15384851364994328708)
,p_item_default=>'B5'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15384856969885328725)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15384857795072328725)
,p_name=>'P2_RETURNFOR'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(15384851364994328708)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15384888546016328726)
,p_name=>'P2_QUERY'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(15384851364994328708)
,p_item_default=>'"MATCH (a:assign) RETURN a"'
,p_prompt=>'Query'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>255
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15384852596823328713)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_WEB_SERVICE'
,p_process_name=>'Web Service Request'
,p_process_sql_clob=>'15384537355154089233:15384537575108089235'
,p_attribute_01=>wwv_flow_api.id(15384537575108089235)
...
wwv_flow_api.create_web_service(
 p_id=>wwv_flow_api.id(15384537355154089233)
,p_name=>'RestfulReL'
...
wwv_flow_api.create_ws_operations(
 p_id=>wwv_flow_api.id(15384537575108089235)
,p_ws_id=>wwv_flow_api.id(15384537355154089233)
,p_name=>'doREST'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15384537857893089239)
,p_ws_opers_id=>wwv_flow_api.id(15384537575108089235)
,p_name=>'query'
,p_input_or_output=>'I'
,p_parm_type=>'string'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15384888982788328726)
,p_parameter_id=>wwv_flow_api.id(15384537857893089239)
,p_process_id=>wwv_flow_api.id(15384852596823328713)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_QUERY'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15384538161160089240)
,p_ws_opers_id=>wwv_flow_api.id(15384537575108089235)
,p_name=>'json'
,p_input_or_output=>'O'
,p_parm_type=>'json'
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15384676691722118409)
,p_ws_opers_id=>wwv_flow_api.id(15384537575108089235)
,p_name=>'DB'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15384853366387328721)
,p_parameter_id=>wwv_flow_api.id(15384676691722118409)
,p_process_id=>wwv_flow_api.id(15384852596823328713)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_DB'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15384676949130118410)
,p_ws_opers_id=>wwv_flow_api.id(15384537575108089235)
,p_name=>'USER'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15384854178676328722)
,p_parameter_id=>wwv_flow_api.id(15384676949130118410)
,p_process_id=>wwv_flow_api.id(15384852596823328713)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_USER'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15384677288067118410)
,p_ws_opers_id=>wwv_flow_api.id(15384537575108089235)
,p_name=>'PASS'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15384854974865328723)
,p_parameter_id=>wwv_flow_api.id(15384677288067118410)
,p_process_id=>wwv_flow_api.id(15384852596823328713)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_PASS'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15384677588973118411)
,p_ws_opers_id=>wwv_flow_api.id(15384537575108089235)
,p_name=>'MODE'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15384855757937328724)
,p_parameter_id=>wwv_flow_api.id(15384677588973118411)
,p_process_id=>wwv_flow_api.id(15384852596823328713)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_MODE'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15384677831319118411)
,p_ws_opers_id=>wwv_flow_api.id(15384537575108089235)
,p_name=>'MODEL'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15384856514206328724)
,p_parameter_id=>wwv_flow_api.id(15384677831319118411)
,p_process_id=>wwv_flow_api.id(15384852596823328713)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_MODEL'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15384688187834118411)
,p_ws_opers_id=>wwv_flow_api.id(15384537575108089235)
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15384857381767328725)
,p_parameter_id=>wwv_flow_api.id(15384688187834118411)
,p_process_id=>wwv_flow_api.id(15384852596823328713)
,p_map_type=>'ITEM'
,p_parm_value=>'P2_RETURNDIMENSIONS'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15384688474526118412)
,p_ws_opers_id=>wwv_flow_api.id(15384537575108089235)
,p_name=>'returnFor'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(15384888102670328726)
,p_parameter_id=>wwv_flow_api.id(15384688474526118412)
,p_process_id=>wwv_flow_api.id(15384852596823328713)
,p_map_type=>'ITEM'
